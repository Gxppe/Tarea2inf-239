...
CREATE TABLE "Direccion_favorita" (
    ...
    CONSTRAINT "Direccion_favorita_pkey" PRIMARY KEY ("direccion_favorita")
);
...
-- AddForeignKey
ALTER TABLE "Direccion_favorita" ADD CONSTRAINT "Direccion_favorita_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "Usuario"("usuario_id") ON DELETE RESTRICT ON UPDATE CASCADE;
